...
const shops: ShopSeed[] = [
  {
    ...
    name: "Тёплые лапки",
    description:
      "Вязаные игрушки ручной работы. Каждый зверёк связан вручную из мягкой хлопковой пряжи — безопасно для детей, тепло для души.",
    city: "Краснодар",
  ...
  },
  {
    ...
    name: "Серебро Кубани",
    description:
      "Авторские украшения из серебра 925°. Минимализм и природные мотивы юга России.",
    city: "Краснодар",
  ...
  },
  {
    ...
    name: "Стол-Арт",
    description:
      "Небольшое мебельное производство: столы-реки и мебель из массива с эпоксидной смолой. Полная прослеживаемость материалов — видно, у кого закуплено сырьё.",
    city: "Краснодар",
    kind: "production",
